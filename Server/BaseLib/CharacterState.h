...
enum eCHARSTATE_FLAG : uint64_t
{
	...
	//CHARSTATE_FLAG_AIRJUMP			= MAKE_BIT_FLAG64(CHARSTATE_AIR_JUMP),
	//CHARSTATE_FLAG_AIRDASH_ACCEL	= MAKE_BIT_FLAG64(CHARSTATE_AIR_DASH_ACCEL),
...
//-----------------------------------------------------------------------------------
enum eCHARCONDITION_FLAG :uint32_t
{
	...
	CHARCOND_FLAG_BURN					= MAKE_BIT_FLAG(CHARCOND_BURN),
...
//	CHARCOND_FLAG_SLOW					= MAKE_BIT_FLAG( CHARCOND_SLOW ),					// 느려짐
	...
	CHARCOND_FLAG_TAIYOU_KEN			= MAKE_BIT_FLAG(CHARCOND_TAIYOU_KEN),
	CHARCOND_FLAG_BATTLE_INABILITY		= MAKE_BIT_FLAG(CHARCOND_BATTLE_INABILITY),
	CHARCOND_FLAG_SKILL_INABILITY		= MAKE_BIT_FLAG(CHARCOND_SKILL_INABILITY),
	CHARCOND_FLAG_REVIVAL_AFTEREFFECT	= MAKE_BIT_FLAG(CHARCOND_REVIVAL_AFTEREFFECT),
	CHARCOND_FLAG_LP_AUTO_RECOVER		= MAKE_BIT_FLAG(CHARCOND_LP_AUTO_RECOVER),
	CHARCOND_FLAG_EP_AUTO_RECOVER		= MAKE_BIT_FLAG(CHARCOND_EP_AUTO_RECOVER),
	CHARCOND_FLAG_RABIES				= MAKE_BIT_FLAG(CHARCOND_RABIES),
	CHARCOND_FLAG_DRUNK					= MAKE_BIT_FLAG(CHARCOND_DRUNK),
	CHARCOND_FLAG_EXCITATION_MALE		= MAKE_BIT_FLAG(CHARCOND_EXCITATION_MALE),
	CHARCOND_FLAG_EXCITATION_FEMALE		= MAKE_BIT_FLAG(CHARCOND_EXCITATION_FEMALE),
